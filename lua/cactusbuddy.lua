...
Group.link('texDelimiter',    g.Statement)
...
Group.link('mkdLink',     g.Statement)
Group.link('mkdListItem', g.Statement)
...
Group.link('rustTrait',          g.Special)
Group.link('rustEnumVariant',    g.Special)
Group.link('rustSigil',          g.User1)
Group.link('rustStorage',        g.User1)
